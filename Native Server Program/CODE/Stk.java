...
public class Stk extends JFrame {
    ...
    Stk() throws IOException, WriterException, NotFoundException {
        ...
        qr.setBorder(BorderFactory.createEmptyBorder(10, 0, 5, 0));
        Upper.add(qr);
        ...
        Scantxt.setBorder(BorderFactory.createEmptyBorder(0, 8, 0, 8));
        Upper.add(Scantxt);
        ...
        restarttxt.setBorder(BorderFactory.createEmptyBorder(60, 0, 3, 0));
